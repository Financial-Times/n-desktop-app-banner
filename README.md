...
To run the demo, run `make init` followd by `make demo`. You should now be able to access this at <http://local.ft.com:5005>... the send email response for the demo is built to always be successful... if you want to see the failed state, update </demos/app.js:30> to return a status other than `200`.
